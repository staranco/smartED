<?php include 'header.php'; ?>
    ...
    <section class="banner">
        <div class="container banner__container">
            ...
            <div class="navigation__item navigation__item_prev"><a href="#" class="navigation__link" title="Anterior"><i class="icon ion-ios-arrow-left"></i></a></div><!--end of navigation__item-->
            <div class="navigation__item navigation__item_next"><a href="#" class="navigation__link" title="Siguiente"><i class="icon ion-ios-arrow-right"></i></a></div><!--end of navigation__item-->

            <div class="carousel">
                <div class="carousel__item" style="background-image: url(img/banner-img-01.jpg)">
                    <div class="carousel__text"><h2>Commercial Training platform by Securitas Direct</h2></div>
                </div><!--end of carousel__item-->
